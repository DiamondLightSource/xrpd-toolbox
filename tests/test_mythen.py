...
import numpy as np
from xrpd_toolbox.utils.utils import gaussian, bin_and_propagate_errors
...
def test_mythen_settings_load_from_toml():
    settings = MythenReductionSettings.load_from_toml("tests/test_data/mythen_settings.toml")
...
def test_peak_averaging():
    ...
    x, y, e = bin_and_propagate_errors(x_combined, y_combined, e_combined, rebin_step=0.1, error_calc='internal')
